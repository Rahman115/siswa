...
define('PATH', 'http://localhost/siswa/'); // isi path dari website anda
// define('PATH', 'http://localhost:8080/siswa/'); // isi path dari website anda
...
define('DB_NAME', 'smk4butur'); // database yang di gunakan
?>
